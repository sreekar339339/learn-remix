...
export function Layout(handle: Handle<{ children: RemixNode, url?: URL, params?: {} }>) {
  return () => (
    <Document>
      <main mix={css({ height: "100vh",     display: "flex",
        ...
        >
          ...
          <a href={routes.asyncActions.withoutFrame.index.href()}>Async actions without Frame</a>
          <a href={routes.asyncActions.withFrame.index.href()}>Async actions with Frame</a>
