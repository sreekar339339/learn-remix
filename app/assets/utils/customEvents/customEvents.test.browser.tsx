...
describe("CustomEvents", () => {
  it("accepts a string union for null-detail event signals", async (t) => {
    ...
    assert.throws(
      () => events(["listUpdated", "listUpdated"] as never),
      ...
      return () => (
        <section data-testid="counter-host" mix={events.host()}>
          <button
            ...
            mix={on("click", ({ currentTarget }) => {
              currentTarget.dispatchEvent(
                events({ count: 0, incrementOffset: 2 }),
              );
            })}
          >
            Prime
          ...
          <button
            ...
            mix={[
              ...
              on("click", ({ currentTarget }) => {
                currentTarget.dispatchEvent(
                  events("count", (count, { incrementOffset }) => {
                    return (
                      (count ?? 0) +
                      (incrementOffset ?? 1)
                    );
        ...
        <section data-testid="counter-host" mix={events.host()}>
          <button
            ...
            mix={[
              ...
              on("click", ({ currentTarget }) => {
                currentTarget.dispatchEvent(events("count", () => undefined));
              }),
            ]}
          >
            Cancel count
